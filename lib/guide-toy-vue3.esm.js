...
export { ReactiveFlags, computed, createApp, createElement, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, insert, isProxy, isReactive, isReadonly, isRef, isShallow, nextTick, patchProp, provide, proxyRefs, reactive, readonly, ref, remove, renderSlot, setElementText, shallowReactive, shallowReadonly, stop, toRaw, track, trackEffect, trigger, triggerEffect, unref };
